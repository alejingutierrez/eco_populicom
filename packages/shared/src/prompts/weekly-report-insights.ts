...
2. **MECANISMO**: ¿qué causó el comportamiento del volumen y del sentimiento? Identifica el(los) evento(s)-disparador concreto(s) y el(los) amplificador(es) (medio profesional, cuenta institucional, organización formal, activista). Conecta la acción de la agencia/contexto → la reacción cuantificable.
