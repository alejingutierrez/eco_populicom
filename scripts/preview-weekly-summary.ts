  ...
  topMentions: [
    {
      ...
      title: 'DDEC extiende el plazo de la convocatoria de incentivos para pymes',
      snippet: 'La agencia anunció una extensión de dos semanas para la convocatoria tras reclamos de gremios empresariales que pedían más tiempo para completar la documentación en línea.',
      url: 'https://www.elnuevodia.com/ejemplo',
    ...
    },
    {
      ...
      title: null,
      snippet: 'Excelente noticia la inversión en la zona oeste: 300 empleos directos prometidos para Mayagüez y Aguadilla. Ojalá se concrete pronto. #DesarrolloPR',
      url: 'https://x.com/example/status/456',
      engagementLabel: '860 interacciones',
      publishedAtLabel: '1 jul',
      tone: 'positive',
    },
    {
      sourceLabel: 'Facebook',
      title: null,
      snippet: 'Tercera semana esperando que el portal del DDEC acepte mis documentos de renovación. Nadie contesta el teléfono de ayuda. Así no se puede.',
      url: 'https://facebook.com/example/posts/789',
      engagementLabel: '540 interacciones',
      publishedAtLabel: '2 jul',
      tone: 'negative',
    },
    {
      sourceLabel: 'Notiuno',
      title: 'Secretario del DDEC defiende el ritmo de la reforma de permisos',
      snippet: 'En entrevista radial, el Secretario aseguró que los tiempos de aprobación bajaron 20% este trimestre, aunque gremios cuestionan la cifra.',
      url: 'https://notiuno.com/ejemplo',
      engagementLabel: '410 interacciones',
      publishedAtLabel: '3 jul',
      tone: 'neutral',
    },
  ],
